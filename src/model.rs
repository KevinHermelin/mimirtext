...
use crate::{
    markdown_view::{LinkRef, LinkTarget, MarkdownDocument, MarkdownView},
    repository::{NoteKey, NoteSnapshot},
    tui_utils::NonIdealState,
};
...
mod tests {
    ...
    mod note_view_model {
        ...
        mod render {
            ...
            #[test]
            fn test_with_note() {
                let note = MockRepository::new().insert_note("Note name.md","this should not be visible.\n\nthis is a test file\n\nwith multiple\n\nparagraphs");
            ...
            fn test_with_new_note() -> Result<()> {
                ...
                let mut model = NotePaneModel::default();
                model.state = NotePaneState::from_note(note);
